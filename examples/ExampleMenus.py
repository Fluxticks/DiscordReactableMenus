...
from discord import Embed, PartialEmoji, Emoji, RawReactionActionEvent

from EmojiHandler import MultiEmoji
from ReactableMenu import ReactableMenu
from examplelib.reactable_lib import clean_mentioned_role, get_role_from_id
...
class RoleReactMenu(ReactableMenu):
    ...
    async def from_dict(cls, bot, data) -> ReactableMenu:
        kwargs = await super().from_dict(bot, data)
